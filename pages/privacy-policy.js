      ...
      <div class="relative isolate bg-white py-10 sm:py-30">
        ...
        <div class="mx-auto max-w-screen-md px-4 md:px-8 mb-16">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to Guess the number, the
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Guess the number.
              </p>
            </li>
            <li>
              <p>
          ...
          <p>
            ...
            directed to that third partys site. We strongly advise You to review
          ...
          <ul>
            <li>
              <p>By email: info@lunitech.co</p>
            </li>
            <li>
              <p>
                By visiting this page on our website:{" "}
                <a
                  href="https://www.lunitech.co/contact"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://www.lunitech.co/contact
                </a>
              </p>
            </li>
          </ul>
