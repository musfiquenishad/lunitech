...
function about() {
  return (
    <div>
      ...
      {/* hero content start */}
      <div>
        <div class="bg-white py-6 sm:py-15 lg:py-12">
          <div class="mx-auto max-w-screen-md px-4 md:px-8">
            ...
            <p class="text-gray-500 sm:text-lg">
              With a focus on quality, we follow rigorous testing methodologies
              to ensure our deliverables exceed expectations. As your partner in
